...
tempDLYDirectory = ""
WP1_Directory = ""
WP1_FOLDER = "Weather_Files\WP1_Files"
COMPLETE_WP1_FOLDER = "Weather_Files\Complete_WP1_Files"
INP_OUT_Directory = ""
INP_OUT = "Weather_Files\INP_OUT_Files"
DAT_FILE_NAME = "WXPMRUN.DAT"
WP1MO_DATA_FILE = "WPM1MO.DAT"
WDLST_DATA_FILE = "WDLSTCOM.DAT"
PRE_FOLDER_DAT_FILE = "Weather_Files/DATFiles"
PRE_FOLDER_DAT_DILE_WINDOW = "\Weather_Files\DATFiles"
EPIC_WEATHER_APPLICATION_FOLDER = "EPIC_Weather_Application"
EXECUTABLE_EXE_FILE_EPIC_APPLICATION = "WXPM3020.exe"
TEMP_DLY = "Weather_Files\Temp_DLY_Files"
EXTEND_FILE_INP = ".INP"
EXTEND_FILE_OUT = ".OUT"
...
if (len(sys.argv) < 2):
    ...
    sys.exit("Usage : python Step_3_main_WEATHER.py -f <Daily Weather Files Folder Path>")
...
if (sys.argv[1] == '-f') :
    if (sys.argv[2] is None) :
        ...
        weather_files_folder = full_path + sys.argv[2]
...
def checkAndCreateFolder():
    directory = full_path + "\Weather_Files"
