...
DAT_DIRECTORY = "Subarea_Files\DAT_Files"
ORIGINAL_SUB_FILE_DIRECTORY = "Subarea_Files\Original_Subarea_Files"
FULL_ORIGINAL_SUB_FILE_DIRECTORY = ""
MODIFIED_SUB_FILE_DIRECTORY = "Subarea_Files\Modified_Subarea_Files"
...
soil_sol_file = ""
FULL_SOICCOM_DAT = ""
SOICOM_DATA_FOLDER_FILE = "3_WISE_SOL_PROJECT\Result_HWSD\DATFiles\SOILCOM.DAT"
opearation_ops_file = ""
FULL_OPSCCOM_DAT = ""
OPSCCOM_DATA_FOLDER_FILE = "6_OPERATIONS_PROJECT\Operation_Files\DAT_Files\OPSCCOM.DAT"
daily_weather_dly_file = ""
FULL_WDLSTCOM_DAT = ""
DAILY_WEATHER_DATA_FOLDER_FILE = "2_WEATHER_PROJECT\Weather_Files\DATFiles\WDLSTCOM.DAT"
...
def checkAndCreateFolder():
    directory = full_path + "\Subarea_Files"
...
def modify_SUB_file(full_path_sub_file, subarea_number, soil_number, operation_number, dly_number, Xcoor, Ycoor, aspect_value,slope_value):
    try:
        ...
        if (slope_value != 0.0 and slope_value != 0):
               line_4 = data[3]
               if (line_4 is None):
                   sys.exit("==[Error] : SUB File is in Wrong Format")
               else:
                   ...
                   str_content = "%s     5.0%s" %(content_REST_1,content_REST_2)
                   line_4 = str_content
