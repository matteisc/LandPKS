...
if (len(sys.argv) < 6):
    ...
    #os.system("python Step_1_preprocessing_HWSD_SPAW_real_time.py -x 15.36858 -y 1.2895 -tif E:/ThanhNguyen_Working/Python_APEX/TIF_FILE_COLLECTION/ -model C:/xampp/htdocs/APEX/Python_APEX/3_WISE_SOL_PROJECT/Model_Application/Core/LPKS_SPAW.xlsx")
    #os.system("python Step_1_preprocessing_HWSD_ROSETTA_real_time.py -x 36.88141147 -y 0.3382613 -tif E:/ThanhNguyen_Working/Python_APEX/TIF_FILE_COLLECTION/ -model C:/xampp/htdocs/APEX/Python_APEX/3_WISE_SOL_PROJECT/Rosetta_Model_Application/Rosetta")
