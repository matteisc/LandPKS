...
if (len(sys.argv) < 6):
    ...
    os.system("python Step_1_preprocessing_HWSD_ROSETTA_real_time.py -x %f -y %f -tif D:/ThanhNguyen_Working/Python_APEX/TIF_FILE_COLLECTION/ -model C:/xampp/htdocs/APEX/Python_APEX/3_WISE_SOL_PROJECT_REAL_TIME/Rosetta_Model_Application/Rosetta -ID %s" %(X_Coor,Y_Coor,ID))#Access GDAL to    
