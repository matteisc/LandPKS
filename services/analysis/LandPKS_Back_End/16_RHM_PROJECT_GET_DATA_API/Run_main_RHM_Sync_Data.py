    ...
    if (RECORDER_NAME.upper() == "ALL"):
        ...
        for  record in lst_records:
            try:
                ...
                rhm_segment = str(record[3])
                rhm_date = str(record[4])
                rhm_canopy_height = str(record[5])
                rhm_canopy_gap = str(record[6])
                rhm_basal_gap = str(record[7])
                rhm_species_1_density = int(record[8])
                rhm_species_2_density = int(record[9])
                rhm_stick_segment_0 = str(record[10])
                rhm_stick_segment_1 = str(record[11])
                rhm_stick_segment_2 = str(record[12])
                rhm_stick_segment_3 = str(record[13])
                rhm_stick_segment_4 = str(record[14])
