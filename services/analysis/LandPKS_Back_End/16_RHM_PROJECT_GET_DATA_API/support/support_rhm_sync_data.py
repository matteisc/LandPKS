...
def insert_rhm_data_to_rhm_store(name, recorder_name, transect, segment, date, canopy_height, canopy_gap, basal_gap, species_1_density, species_2_density, species_list, 
