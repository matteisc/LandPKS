...
def get_average_value_for_period_time_AgMERRA(month, start_year, end_year, type, X_Coor, Y_Coor):
    ...
    for year in range(start_year, end_year + 1):
        ...
        if (type.strip().upper() == DEFINE_PRECIPITATION):
           TIF_FILE = TIF_FOLDER_COMM + "CLIMATE_SUMMARY/AGMERRA_TIF/AgMERRA_Prate_Monthly/%s_%s_%s.tif" %(str("prate"),str(month),str(year))
        elif (type.strip().upper() == DEFINE_TEMPERATURE_AVG):
           TIF_FILE = TIF_FOLDER_COMM + "CLIMATE_SUMMARY/AGMERRA_TIF/AgMERRA_TAvg_Monthly/%s_%s_%s.tif" %(str("tmp"),str(month),str(year))
        elif (type.strip().upper() == DEFINE_TEMPERATURE_MAX):
           TIF_FILE = TIF_FOLDER_COMM + "CLIMATE_SUMMARY/AGMERRA_TIF/AgMERRA_TMax_Monthly/%s_%s_%s.tif" %(str("tmax"),str(month),str(year))
        elif (type.strip().upper() == DEFINE_TEMPERATURE_MIN):
           TIF_FILE = TIF_FOLDER_COMM + "CLIMATE_SUMMARY/AGMERRA_TIF/AgMERRA_TMin_Monthly/%s_%s_%s.tif" %(str("tmin"),str(month),str(year))
        else:
...
def get_climate_information_from_AgMERRA_Data(X_COOR,Y_COOR):
    ...
    d['min_temperature']['january'] = get_average_value_for_period_time_AgMERRA('01',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['february'] = get_average_value_for_period_time_AgMERRA('02',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['march'] = get_average_value_for_period_time_AgMERRA('03',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['april'] = get_average_value_for_period_time_AgMERRA('04',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['may'] = get_average_value_for_period_time_AgMERRA('05',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['june'] = get_average_value_for_period_time_AgMERRA('06',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['july'] = get_average_value_for_period_time_AgMERRA('07',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['august'] = get_average_value_for_period_time_AgMERRA('08',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['september'] = get_average_value_for_period_time_AgMERRA('09',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['october'] = get_average_value_for_period_time_AgMERRA('10',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['november'] = get_average_value_for_period_time_AgMERRA('11',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    d['min_temperature']['december'] = get_average_value_for_period_time_AgMERRA('12',1980,2010,DEFINE_TEMPERATURE_MIN,X_COOR,Y_COOR)
    return d
def get_climate_data_set(X_Coor,Y_Coor,Source):    
       ...
       if (Source == "CRU"):
           ...
           #d = get_climate_information_from_AgMERRA_Data(X_Coor,Y_Coor)
